...
def calculate_token_ratio(original_text, preprocessed_text):
    original_tokens = word_tokenize(original_text)
    preprocessed_tokens = word_tokenize(preprocessed_text)
    original_token_count = len(original_tokens)
    preprocessed_token_count = len(preprocessed_tokens)
    compression_ratio = preprocessed_token_count / original_token_count
...
if "__name__" == "__main__":
    ...
    ratio = calculate_token_ratio(text, preprocessed_text)
    print(ratio)
